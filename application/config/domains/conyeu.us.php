...
$config['static_url'] = "https://www.chuongduong.net/frontend-skin";
...
|
*/
$config['cache_path'] = APPPATH . 'cache/conyeu/';
...
$config['default_category'] = 'Nhật ký';

$config['media_folder'] = 'conyeu/';
